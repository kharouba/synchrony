...
total3<-read.csv("input/raw_oct.csv", header=TRUE, na.strings="NA", as.is=TRUE)
...
sub7<-subset(clim3, studyid=="HMK051" & species=="Caterpillar4a spp.")
...
sub15<-subset(clim3, studyid=="HMK018" & species=="Pygoscelis antarcticus")
